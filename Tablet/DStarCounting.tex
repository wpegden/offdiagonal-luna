...
sufficiently large power of two $q$ and every $k\geq Cq(\operatorname{Nat.log}q)^2$,
...
\]
Here $\operatorname{Nat.log}$ is the base-two natural-number logarithm used
...
$q=2^m$, and suppose
\[
        k\geq Cq(\operatorname{Nat.log}q)^2.                 \tag{1}
\]
Since $q\geq2$, $\operatorname{Nat.log}q=m$; put $L=m$.  Thus the exact
