...
If this graph contained a clique $u_1,\ldots,u_s$, list those vertices in
increasing order of their $\pi$-values.  For every $i<j$, the edge between
$u_i$ and $u_j$ was created by an arc $(u_i,u_j)$, so the ordered vertices
would form a copy of $T_s$, contradicting the assumed $T_s$-freeness.
