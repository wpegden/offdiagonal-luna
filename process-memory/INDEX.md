...
- [pm-0006-do-not-wrap-the-permutation-reduction] refuted-route/global — The current `RandomPermutationReduction` theorem already has the correct random construction, clique elimination, expectation estimate, and factorial bound. The
